...
<p align="center">:bangbang: Documentation available to access at: https://nitaicharan.github.io/Udemy-CCDNJSMDB1 :bangbang:</p>

<!--[![](PREVIEW.png)](https://nitaicharan.github.io/Udemy-CCDNJSMDB1/)-->
<a href="https://nitaicharan.github.io/Udemy-CCDNJSMDB1">
  <p align="center">
    <img src="PREVIEW.png">
  </p>
</a>
...
This project was part of the Udemy course "Curso Completo do Desenvolvedor NodeJS e MongoDB" by Jorge Sant Ana.
...
This certificate above verifies that [Nitai Charan][udemy-url] successfully completed the course [Curso Completo do Desenvolvedor NodeJS e MongoDB][course-url] on ??/??/??? as taught by [Jorge Sant Ana][instructor-url] on Udemy. The certificate indicates the entire course was completed as validated by the student.
...
```
ng build
index.html:base:"/" -> index.html:base:"/Udemy-CCDNJSMDB1/"
...
[course-url]: https://www.udemy.com/course/curso-completo-do-desenvolvedor-nodejs/
[instructor-url]: https://udemy.com/user/jorgetadeusantanasilva/
[certificate-url]: #
